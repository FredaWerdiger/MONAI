...
metrics_affine = []
scale_range = [0, 0.1, 0.5, 1.]
for i in scale_range:
    print(f"gamma range from 1 to {i}")
    train_transforms = Compose(
        [
            ...
            RandAdjustContrastd(keys="image", prob=1.0, gamma=(0.5, 1)),
            RandAffined(
                keys=['image', 'label'],
...
for a, b in zip(scale_range, metrics_affine):
    print(f"Dice overlap for scaling factor {a}: {b}")
